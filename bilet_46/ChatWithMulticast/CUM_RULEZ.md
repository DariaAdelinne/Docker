# Bilet 46 (SPLSD-41) — Chat cu Multicast + Microserviciu WEB

> Acelasi sistem ca Bilet 26, plus un **microserviciu web nou** (`WebController`)
> care afiseaza pagina cu toti utilizatorii activi si permite trimiterea multicast din browser.
